      ...
      <section className="roadmap-boundaries section-pad">
        <div className="container">
          ...
          <div className="boundary-list">{[
            ...
            ['04', '移动交付', '移动游客端收敛为 Android App、HarmonyOS 与微信小程序三端；前两端已提供安装包，微信入口待二维码更新。'],
      ...
      <section className="next-road section-pad">
        <div className="container">
          ...
          <div className="milestone-grid">
            {[
              ['阶段 0', '三端能力矩阵', '统一 Android App、HarmonyOS 与微信小程序的地图、录音、流式请求与数字人能力边界。'],
              ['阶段 1', '安装包交付', 'Android APK 与 HarmonyOS HAP 进入自有下载站，保持版本与校验信息可追溯。'],
              ['阶段 2', '核心闭环真机化', '首页景点 → 地图定位 → AI 讲解 → 生成路线 → 保存行程。'],
              ['阶段 3+', '微信入口收敛', '二维码就绪后补齐微信小程序入口，并继续验证弱网、权限与真机性能。'],
