  ...
  },
  {
    ...
    content: <>
      <article className="thanks-prose">
        <h1>致谢</h1>
        <p>一项作品的最终交付，从来不是某一个人的独行。谨以此页，记录数智游踪从构想到落地过程中收到的每一份指引、坚守、耐心与信任。</p>
        ...
        <p>我们向本届大赛的主办单位工业和信息化部、教育部、江苏省人民政府，出题企业锐捷网络（苏州）有限公司，以及各承办单位与大赛组委会致以最诚挚的谢意。感谢赛事平台为全国青年学子搭建起连接产业需求、展现软件创新能力、碰撞技术思想的国家级专业舞台。从贴合产业前沿的赛题设置，到全流程规范有序的赛事组织，再到总决赛的周全保障，每一处环节的精心安排，都为我们的参赛实践与能力成长保驾护航。</p>

        <h2 id="support">答疑支持</h2>
        <p>特别感谢组委会老师在 QQ 群答疑期间给予的细心解答。一次次及时、明确的回应，帮助我们更准确地理解参赛要求，也让团队能够把更多精力投入作品本身。在此，特别感谢 <a className="thanks-mail-link" href="mailto:2219396984@qq.com" aria-label="发送邮件给王佳琳老师" title="发送邮件至 2219396984@qq.com">王佳琳老师（2219396984@qq.com）</a>、<a className="thanks-mail-link" href="mailto:568735108@qq.com" aria-label="发送邮件给王艳老师" title="发送邮件至 568735108@qq.com">王艳老师（568735108@qq.com）</a>与<a className="thanks-mail-link" href="mailto:3216299230@qq.com" aria-label="发送邮件给马溪若老师" title="发送邮件至 3216299230@qq.com">马溪若老师（3216299230@qq.com）</a>的耐心帮助。</p>
        ...
        <p>数智游踪的完成也离不开 Vue、Node.js、Leaflet、Electron 等开源社区，以及科大讯飞、腾讯位置服务与 Live2D 相关技术生态提供的能力基础。</p>

        <h2 id="closing">写在最后</h2>
        <h3>经历本身，就是答案。</h3>
        <p>无论最终成绩如何，这段全力以赴的经历已是我们大学生涯中最珍贵的财富。我们深信，在项目中淬炼出的系统工程思维与团队协作经验，必将在未来的学习和工作中持续发光发热。</p>
      </article>
    </>,
  },
]
