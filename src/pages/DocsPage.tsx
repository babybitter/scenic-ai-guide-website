...
const pages: DocPage[] = [
  ...
  },
  {
    ...
    content: <>
      <article className="thanks-prose">
        <h1>致谢</h1>
        <p>一项作品的<strong>最终交付</strong>，从来不是某一个人的独行。谨以此页，记录<strong>数智游踪</strong>从构想到落地过程中收到的每一份<strong>指引、坚守、耐心与信任</strong>。</p>

        <h2 id="journey">一路同行</h2>
        <p>回望从备赛到最终交付的整个历程，我们跨越了一个又一个难点，也在<strong>持续验证、推翻与重建</strong>中完成了宝贵的蜕变与成长。每一次突破的背后，都有<strong>同行者的托举</strong>。</p>

        <h2 id="mentor-team">指导与团队</h2>
        <h3>陈子淮指导老师</h3>
        <p>由衷感谢<strong>陈子淮指导老师</strong>在全过程中的悉心指引与无私帮助。从<strong>选题方向的敲定、技术路线的梳理</strong>，到<strong>核心难点的攻克</strong>，每一步突破都离不开您的倾囊相授与耐心把关。</p>
        <h3>张婧瑜、季祥、林骏毅</h3>
        <p>感谢团队成员<strong>张婧瑜、季祥、林骏毅</strong>在无数个深夜并肩调试、反复迭代的坚守与付出。正是彼此间的<strong>信任、坦诚与默契协作</strong>，支撑我们把一个想法打磨成完整系统，并一路走到总决赛的舞台。</p>

        <h2 id="organizers">赛事组织</h2>
        <p>我们向本届大赛的<strong>主办单位</strong>——<strong>工业和信息化部、教育部、江苏省人民政府</strong>，<strong>出题企业</strong>——<strong>锐捷网络（苏州）有限公司</strong>，以及<strong>各承办单位与大赛组委会</strong>致以最诚挚的谢意。感谢赛事平台为全国青年学子搭建起<strong>连接产业需求、展现软件创新能力、碰撞技术思想</strong>的国家级专业舞台。从贴合产业前沿的赛题设置，到全流程规范有序的赛事组织，再到总决赛的周全保障，每一处环节的精心安排，都为我们的参赛实践与能力成长保驾护航。</p>
        ...
        <p>感谢<strong>各位评委专家</strong>在百忙之中拨冗评审，耐心聆听我们的项目汇报。<strong>严谨的专业视角与中肯的点评建议</strong>，不仅帮助我们清晰认识到项目的不足与优化空间，也让我们对<strong>软件技术的产业落地价值</strong>有了更深刻的理解，为未来的技术实践与职业发展指明了方向。</p>

        <h2 id="ecosystem">技术生态</h2>
        <p><strong>数智游踪</strong>的完成也离不开<strong>Vue、Node.js、Leaflet、Electron 等开源社区</strong>，以及<strong>科大讯飞、腾讯位置服务与 Live2D 相关技术生态</strong>提供的能力基础。</p>

        <h2 id="closing">写在最后</h2>
        <h3>经历本身，就是答案。</h3>
        <p>无论最终成绩如何，这段<strong>全力以赴的经历</strong>已是我们大学生涯中最珍贵的财富。我们深信，在项目中淬炼出的<strong>系统工程思维与团队协作经验</strong>，必将在未来的学习和工作中持续发光发热。</p>
      </article>
    </>,
  },
]
