...
const commonCopy = {
  'zh-CN': {
    ...
    accessBody: '网页端立即体验，桌面端面向稳定演示与景区终端交付；安装包统一由自有 Linux 下载服务器分发，不依赖 GitHub Release。',
    availableNow: '现在可用',
  ...
  en: {
    ...
    accessBody: 'Try the web version instantly or use a desktop client for stable demos and scenic-terminal delivery. Installers are distributed from our own Linux server, independent of GitHub Releases.',
